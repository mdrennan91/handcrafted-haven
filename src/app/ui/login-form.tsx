    ...
    <>
      ...
      <form action={formAction} className="space-y-3.5">
        <div className="flex-1 rounded-lg bg-[var(--accent1)] px-5 pb-4 pt-9">
          <h1
            className={`${lusitana.className} mb-3 text-2xl text-[var(--primary-light)]`}
          >
            Please sign in to continue.
          </h1>
          <div className="w-full">
            <label
              className="mb-3 mt-5 block text-sm/8 font-medium text-[var(--primary-light)]"
              htmlFor="email"
            >
              Email
              <input
          ...
          <Button className="mt-4 bg-[var(--secondary)] hover:bg-[var(--secondary-light)] text-black transition-transform duration-200 hover:scale-105">
            Sign In
          </Button>
